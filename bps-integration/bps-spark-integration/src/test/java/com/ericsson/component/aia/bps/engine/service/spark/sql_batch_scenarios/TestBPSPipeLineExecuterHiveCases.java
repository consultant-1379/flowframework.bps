...
public class TestBPSPipeLineExecuterHiveCases extends TestBPSPipeLineExecuterBase {
     ...
     */
    public TestBPSPipeLineExecuterHiveCases(final String name, final Class<? extends TestMockBaseContext> inputType,
