...
/**
 * The Class TestBPSPipeLineExecuterJdbcCases.
 */
@RunWith(Parameterized.class)
public class TestBPSPipeLineExecuterJdbcCases extends TestBPSPipeLineExecuterBase {
     ...
     */
    public TestBPSPipeLineExecuterJdbcCases(final String name, final Class<? extends TestMockBaseContext> inputType,
    ...
    public static Collection<Object[]> data() throws Exception {
        return provideData(TestType.JDBC);
    }
}
