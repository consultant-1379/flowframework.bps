...
/**
 * The Class TestBPSPipeLineExecuterFileCases.
 */
@RunWith(Parameterized.class)
public class TestBPSPipeLineExecuterFileCases extends TestBPSPipeLineExecuterBase {

    /**
     * Instantiates a new test BPS pipe line executer file cases.
     *
     * @param name
     *            the name
     * @param inputType
     ...
     */
    public TestBPSPipeLineExecuterFileCases(final String name, final Class<? extends TestMockBaseContext> inputType,
    ...
    public static Collection<Object[]> data() throws Exception {
        return provideData(TestType.FILE);
    }
